...
function Projects()
{
    const projects = [
        ...
        },
        {
            ...
            description: "Extraordinary Desserts is an online Bakery shop. Customers can create online account, view different categories of cakes, place order, view order history, and add baking recipes",
